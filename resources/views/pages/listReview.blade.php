    ...
    <div class="wrapper">
       <div class="page-header page-header-small clear-filter" filter-color="orange">
        ...
        <div class="section section-tabs text-center">
            <div class="container">
                <h2 class="title">Review Mereka Untuk DKi Jakarta</h2>
                <p class="description">Review mereka tentang layanan darurat yang dibawahi oleh Pemerintah Provinsi DKI Jakarta</p>
                <div class="row">
                    <div class="card col-lg-8 text-center col-md-12 ml-auto mr-auto">
                        <form class="form" method="POST" action="{{ route('searchReview')}}" enctype="multipart/form-data">
                            {{ csrf_field() }}

                            <div class="row">
                                <div class="col-sm-8 text-center">
                                    <div class="form-group">
                                        <input type="text" name="searchKey" placeholder="Pencarian" class="form-control btn btn-block">
                                    </div>
                                </div>

                                <div class="col-sm-4 text-center">
                                  <button type="submit" class="btn btn-primary btn-round btn-block btn">CARI
                                  </button>
                                </div>
                            </div>
                    ...
                    <div class="col-lg-8 text-center col-md-12 ml-auto mr-auto">
                      @foreach ($reviews as $key => $value)
                        <div class="card">
                            <blockquote class="Muted Text blockquote blockquote-Muted">
                            <p>
                                @if ($value->img_review != null)
                                  <img src="/img/reviewImg/{{$value->img_review}}"  class="img-raised" width="200%" height="300px"/><br><br>
                                @endif


                                <h6 class="text-left">Jenis Review: {{$value->review_type}}<br>
                                Layanan: {{$value->service_identifier}}</h6><br>

                                " {{ $value->review_content }} " <b>( {{ $value->created_at->diffForHumans() }} )</b>
                                <br>
                                <br>
                            </p>
                            <h5 class="text-center">Ratting:
                              @for ($i=0; $i <5; $i++)
